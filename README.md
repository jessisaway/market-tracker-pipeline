...
> **Data Engineering Pipeline & Real-time Business Intelligence**
...
1.  **Monitorar** ativos de forma automatizada.
...
3.  **Armazenamento (Load):**
    - `market_status.json`: Estado atual para leitura rápida do Dashboard.
...
Para forçar uma atualização dos dados:
```
python main.py
```
